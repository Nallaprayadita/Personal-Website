	...
	return (
		<section id="contact" className="space-y-6">
			...
			<p className="text-zinc-800 dark:text-zinc-200">
				I’m open to collaboration in software and web development projects. Feel free to connect if you need help or want to share knowledge!
			</p>
			<div className="flex gap-x-6 mt-6 flex-col md:flex-row gap-y-2">
				<span className="text-zinc-500 dark:text-zinc-300">prayaditanalla@gmail.com</span>
				<a href="https://youtube.com/@nallaprayadita8447?si=Re75Nt2LsWfKRlTC" className="text-zinc-500 dark:text-zinc-300 flex items-center gap-x-2.5">
